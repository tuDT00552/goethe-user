...
function App() {
    ...
    function searchUsers() {
        return users.filter(user =>
            ...
            user.module.toLowerCase().includes(searchKeyword.toLowerCase()) ||
            user.moduleBackup.toLowerCase().includes(searchKeyword.toLowerCase()) ||
            user.startDate.toLowerCase().includes(searchKeyword.toLowerCase()) ||
            user.endDate.toLowerCase().includes(searchKeyword.toLowerCase())
        );
    }
                        ...
                        <li key={item.id} className="px-4 py-4 sm:px-0">
                            <div className={`flex justify-between`}>
                                ...
                                <div className={`flex flex-col gap-y-3`}>
                                    ...
                                    <button onClick={() => updateIsActive(item.id, item.isActive ? 0 : 1)}>
                                        {!item.isActive ?
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                strokeWidth="1.5" stroke="currentColor"
